<%@ Page Title="" Language="C#" MasterPageFile="~/Engineer/MasterPage_Engineer.master" AutoEventWireup="true" CodeFile="Message_Outbox.aspx.cs" Inherits="Engineer_Message_Outbox" %>
                                ...
                                <ItemTemplate>
                                    <table class="table table-responsive table-hover table-striped">
                                        <tr>
                                            ...
                                            <td class="sml40">
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/Engineer/Message_Detail2.aspx?id=" +Eval("message_id") %>' Text='<%# Eval("subject") %>'></asp:HyperLink></td>
                                            <td class="sml20">
                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("date").ToString().Substring(0,10) %>'></asp:Label></td>
                                            <td class="sml20">
                                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("time") %>'></asp:Label></td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
                            </asp:DataList>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BorderColor="White" CssClass="table table-hover table-striped">
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/Engineer/Message_Detail2.aspx?id=" +Eval("message_id") %>' Text='<%# Eval("subject") %>'></asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>

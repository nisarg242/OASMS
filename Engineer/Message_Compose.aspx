<%@ Page Title="" Language="C#" MasterPageFile="~/Engineer/MasterPage_Engineer.master" AutoEventWireup="true" CodeFile="Message_Compose.aspx.cs" Inherits="Engineer_Message_Compose" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="dataTable_wrapper">
                            <asp:GridView runat="server" CssClass="table table-striped table-bordered table-hover text-center" ID="gvUsers" AutoGenerateColumns="false" OnRowCommand="gvUsers_RowCommand1">
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>

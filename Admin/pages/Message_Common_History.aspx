<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/pages/admin.master" AutoEventWireup="true" CodeFile="Message_Common_History.aspx.cs" Inherits="Admin_pages_Message_Common_History" %>
                                ...
                                <ItemTemplate>
                                    <table class="table table-responsive table-hover table-striped">
                                        <tr>
                                            ...
                                            <td class="sml40">
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/Admin/pages/Message_Detail_Common.aspx?id=" +Eval("message_id") %>' Text='<%# Eval("subject") %>'></asp:HyperLink></td>
                                            <td class="sml20">

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/pages/admin.master" AutoEventWireup="true" CodeFile="Message_Common.aspx.cs" Inherits="Admin_pages_Message_Common" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="color: #e0a148;">Common Message</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class=" well panel-primary">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label>Message</label>
                                    <asp:TextBox ID="txtMsg" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="4" placeholder="Write Message here..."></asp:TextBox>

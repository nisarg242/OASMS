<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/MasterPage_Employee.master" AutoEventWireup="true" CodeFile="Outbox_Emp.aspx.cs" Inherits="Employee_Outbox_Emp" %>
                                ...
                                <ItemTemplate>
                                    <table class="table table-responsive table-hover table-striped">
                                        <tr>
                                            ...
                                            <td class="sml40">
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/Employee/Message_Detail.aspx?id=" +Eval("message_id") %>' Text='<%# Eval("subject") %>'></asp:HyperLink></td>
                                            <td class="sml20">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BorderColor="White" CssClass="table table-hover table-striped">
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/Employee/Message_Detail.aspx?id=" +Eval("message_id") %>' Text='<%# Eval("subject") %>'></asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
